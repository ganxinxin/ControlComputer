...
public class BookmarkActivity extends PreferenceActivity implements OnSharedPreferenceChangeListener {
	...
	private void setIntentComponentNames() {
		...
		String[] prefKeys = { "bookmark.credentials", "bookmark.screen", "bookmark.performance", "bookmark.advanced", "bookmark.screen_3g", "bookmark.performance_3g", "bookmark.gateway_settings" };
	...
	public void onBackPressed() {
		...
		if (!verifySettings(sharedPreferences)) {
			...
			builder.setTitle(R.string.error_bookmark_incomplete_title).setMessage(R.string.error_bookmark_incomplete).setPositiveButton(R.string.cancel, new DialogInterface.OnClickListener() {
				@Override
			...
			if (new_bookmark || settings_changed) {
				AlertDialog.Builder builder = new AlertDialog.Builder(this);
				builder.setTitle(R.string.dlg_title_save_bookmark).setMessage(R.string.dlg_save_bookmark).setPositiveButton(R.string.yes, new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface dialog, int which) {
